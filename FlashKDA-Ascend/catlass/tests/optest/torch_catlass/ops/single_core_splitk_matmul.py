...
def single_core_splitk_matmul(
    ...
    """Run CATLASS single core split-K matmul on NPU tensors.

    Source: example 34_single_core_splitk_matmul.
    ...
    return torch.ops.catlass.single_core_splitk_matmul(
