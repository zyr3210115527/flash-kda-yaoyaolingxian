...
def ascend950_basic_matmul(
    ...
    """Run CATLASS Ascend950 basic matmul TLA on NPU tensors.

    Source: example 43_ascend950_basic_matmul.
    ...
    return torch.ops.catlass.ascend950_basic_matmul(
