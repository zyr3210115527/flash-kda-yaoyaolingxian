...
def flash_attention_infer_tla(
    ...
    """Run CATLASS flash attention inference (TLA) on NPU tensors.

    Source: example 40_flash_attention_infer_tla.
    ...
    """
    return torch.ops.catlass.flash_attention_infer_tla(
        query,
        key,
        value,
        actual_seq_lengths,
