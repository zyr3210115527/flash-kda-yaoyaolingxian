...
def quant_multi_core_splitk_matmul_tla(
    mat1: Tensor,
    mat2: Tensor,
    scale: Tensor,
    ...
    """Run CATLASS quantized multi-core splitK matmul (TLA) on NPU tensors.
    ...
    return torch.ops.catlass.quant_multi_core_splitk_matmul_tla(
