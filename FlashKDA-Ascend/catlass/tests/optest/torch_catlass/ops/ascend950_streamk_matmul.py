...
def ascend950_streamk_matmul(
    ...
    """Run CATLASS Ascend950 streamk matmul TLA on NPU tensors.

    Source: example 66_ascend950_streamk_matmul.
    ...
    return torch.ops.catlass.ascend950_streamk_matmul(
