...
def basic_matmul_preload_zN(
    ...
    """Run CATLASS basic matmul with zN preload on NPU tensors.

    Source: example 21_basic_matmul_preload_zN.
    ...
    return torch.ops.catlass.basic_matmul_preload_zN(
