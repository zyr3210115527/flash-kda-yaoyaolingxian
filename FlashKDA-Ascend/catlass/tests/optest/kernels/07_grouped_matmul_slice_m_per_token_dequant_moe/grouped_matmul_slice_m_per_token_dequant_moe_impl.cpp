...
using DispatchPolicy = Gemm::MmadAtlasA2PreloadAsync<1, 2, 2, 4, 1, false, true>;
using L1TileShape = typename CatlassKernel::TileShapeScaler<ElementA, int8_t, GemmShape<128, 256, 256>>::type;
using L0TileShape = typename CatlassKernel::TileShapeScaler<ElementA, int8_t, GemmShape<128, 256, 64>>::type;
...
using MatmulKernel = Gemm::Kernel::GroupedMatmulSliceMPerTokenDequant<
    BlockMmad, BlockEpilogue, BlockScheduler, int32_t>;
...
extern "C" void run(uint32_t blockNum, aclrtStream stream, const CatlassKernel::MatmulParams* params)
{
    ...
    typename MatmulKernel::Arguments arguments{
        shape, params->batch, params->inputAddr[2],
