...
using BlockSchedulerFullLoad10 = typename Gemm::Block::GemmIdentityBlockSwizzleL1FullLoad<1, 0>;
using BlockScheduler30 = typename Gemm::Block::GemmIdentityBlockSwizzle<3, 0>;

#ifndef CATLASS_JIT_BLOCK_SCHEDULER
#define CATLASS_JIT_BLOCK_SCHEDULER BlockSchedulerFullLoad10
#endif
...
extern "C" void run(uint32_t blockNum, aclrtStream stream, const CatlassKernel::MatmulParams* params)
{
    ...
    typename MatmulKernel::Arguments arguments{
        ...
        blockNum,
        {deviceA, layoutA, deviceB, layoutB, nullptr},
