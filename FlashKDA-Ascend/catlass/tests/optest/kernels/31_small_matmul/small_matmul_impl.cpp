...
using DispatchPolicy = Catlass::Gemm::MmadAtlasA2Small<2, true, false>;
...
using MatmulKernel = Catlass::Gemm::Kernel::SmallMatmul<BlockMmad, BlockEpilogue, BlockScheduler>;
