...
#ifndef OPTEST_BASIC_CONV2D_H
#define OPTEST_BASIC_CONV2D_H
...
struct BasicConv2dOp {
        ...
        const std::vector<int64_t>& padding, const std::vector<int64_t>& dilation)
    {
        ...
        TORCH_CHECK(dtype == ACL_FLOAT16, "basic_conv2d supports float16 only (in current prebuilt mode)");
        ...
        CatlassKernel::BasicConv2d(aicCoreNum, stream, params);
