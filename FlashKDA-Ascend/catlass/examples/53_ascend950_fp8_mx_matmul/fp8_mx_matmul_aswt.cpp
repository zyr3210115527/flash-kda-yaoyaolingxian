...
static void Run(const Options& options)
{
    ...
    size_t lenMxScaleA = static_cast<size_t>(static_cast<uint64_t>(m) * static_cast<uint64_t>(mxScaleAlignedK));
    size_t lenMxScaleB = static_cast<size_t>(static_cast<uint64_t>(mxScaleAlignedK) * static_cast<uint64_t>(n));
