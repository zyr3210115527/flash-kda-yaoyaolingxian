...
public:
    CATLASS_HOST_DEVICE
    Conv3dParams(
        Index BATCH = 1, Index Di = 1, Index Cin1 = 1, Index Hi = 1, Index Wi = 1, Index C0 = 16, Index Kd = 1,
        Index Kh = 1, Index Kw = 1, Index N1 = 1, Index Do = 1, Index Ho = 1, Index Wo = 1, Index Cout1 = 1,
        Index Cout = 1, Index padHead = 0, Index padTop = 0, Index padLeft = 0, Index strideD = 1, Index strideH = 1,
        Index strideW = 1, Index dilationD = 1, Index dilationH = 1, Index dilationW = 1)
    ...
    static Conv3dParams MakeConvCoord(
        const uint32_t* fmapShape, const uint32_t* filterShape, const uint32_t* paddings, const uint32_t* strides,
...
public:
    Conv2dFilterParams(
        ShortIndex kh = 0, ShortIndex kw = 0, ShortIndex padLeft = 0, ShortIndex padRight = 0, ShortIndex padTop = 0,
        ShortIndex padBottom = 0, ShortIndex strideH = 0, ShortIndex strideW = 0, ShortIndex dilationH = 0,
        ShortIndex dilationW = 0)
        : ks(MakeCoord(kh, kw)),
...
public:
    ...
    CATLASS_HOST_DEVICE
    Conv2dParams(
        Index batch, Index hi, Index wi, Index cin, Index cout, ShortIndex kh, ShortIndex kw, ShortIndex padLeft,
        ShortIndex padRight, ShortIndex padTop, ShortIndex padBottom, ShortIndex strideH, ShortIndex strideW,
    ...
    {
        return Conv2dParams(
            dataSizes[0], dataSizes[1], dataSizes[2], dataSizes[3], dataSizes[4], filterSizes[0], filterSizes[1],
            pads[0], pads[1], pads[2], pads[3], strides[0], strides[1], strides[2], strides[3]);
    }
