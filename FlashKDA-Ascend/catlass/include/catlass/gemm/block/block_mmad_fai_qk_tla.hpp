...
struct BlockMmadTla<
    MmadFAIQK<Arch::Ascend950, PAGED_CACHE_FLAG_, ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, ElementA_, ElementB_,
...
public:
    ...
    CATLASS_DEVICE void operator()(
        TensorA& tensorA, TensorB& tensorB, TensorC& tensorC, AscendC::GlobalTensor<int32_t>& blockTable,
        Shape& actualShape, int64_t taskId, int32_t blockSize, bool isFirstLoop = false, bool isLastLoop = false)
    {
