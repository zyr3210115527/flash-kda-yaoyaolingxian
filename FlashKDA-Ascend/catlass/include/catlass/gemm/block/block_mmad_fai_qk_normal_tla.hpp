...
struct BlockMmadTla<
    MmadFAIQK<ArchTag_, PAGED_CACHE_FLAG_, ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, ElementA_, ElementB_,
...
public:
    ...
    CATLASS_DEVICE void computeQK(
        ...
        uint32_t strideKV, bool firstItr, bool endItr, bool initMmad, bool firstQItr, bool endQItr)
    {
