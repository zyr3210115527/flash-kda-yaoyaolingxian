        ...
        for (uint32_t rowLoopIdx = 0; rowLoopIdx < rowLoopNum + preLoad; rowLoopIdx++) {
            ...
            if (rowLoopIdx >= preLoad) {
                ...
                SubCoreCompute<MaskCategory::NO_MASK>(
                    gOutputCurLoop, layoutOutputCurLoop, rowOffsetCurLoop, isFirstStackTile, columnNumRound,
        ...
        for (uint32_t rowLoopIdx = 0; rowLoopIdx < rowLoopNum + preLoad; rowLoopIdx++) {
            if (rowLoopIdx < rowLoopNum) {
                ...
                if (rowLoopIdx == 0) {
                    ...
                    CopyMaskGmToUb(
                        gMaskThisSubBlock, columnNum, columnNumRound, maskStride, tokenNumPerHeadThisSubBlock,
