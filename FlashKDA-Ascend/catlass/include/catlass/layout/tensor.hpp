...
public:
    ...
    CATLASS_HOST_DEVICE
    NC1HWC0(
        Index batch, Index c1, Index h, Index w, Index c0, LongIndex strideBatch, LongIndex strideC1, LongIndex strideH,
        LongIndex strideW, LongIndex strideC0)
...
public:
    ...
    CATLASS_HOST_DEVICE
    CI1KHKWCOCI0(
        Index cin1, Index kh, Index kw, Index cout, Index c0, LongIndex strideCin1, LongIndex strideKh,
